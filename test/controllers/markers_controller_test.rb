...
class MarkersControllerTest < ActionController::TestCase
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post :create, marker: { description: @marker.description, lat: @marker.lat, long: @marker.long, rou_id: @marker.rou_id }
    end
  ...
  test "should update marker" do
    patch :update, id: @marker, marker: { description: @marker.description, lat: @marker.lat, long: @marker.long, rou_id: @marker.rou_id }
    assert_redirected_to marker_path(assigns(:marker))
  end
